<meta charset="utf-8">
  ...
  <link href="{{ URL::asset('backend/assets/vendor/icofont/icofont.min.css') }}" rel="stylesheet">
  <link href="{{ URL::asset('backend/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
  <link href="{{ URL::asset('backend/assets/vendor/venobox/venobox.css') }}" rel="stylesheet">
  <link href="{{ URL::asset('backend/assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
  <link href="{{ URL::asset('backend/assets/vendor/aos/aos.css') }}" rel="stylesheet">
